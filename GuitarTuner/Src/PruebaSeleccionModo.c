 ...
 * @brief          : Prueba para implementar dos modos de funcionamiento:
 * 					 - Detección automática de la cuerda que se quiere afinar
 * 					 - Selección manual de la cuerda a afinar
 ******************************************************************************
 **/
